...
class PageBase(object):
    ...
    incorrect_params{}
    #Params that are ok. Stored in dict se we are not constantly going to the server and fetching values. Just update this after a value has been saved ok in the database
    params ={}
